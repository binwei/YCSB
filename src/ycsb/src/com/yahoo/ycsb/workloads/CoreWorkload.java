...
public class CoreWorkload extends Workload {
    ...
    Map<String, ByteIterator> buildValues() {
    ...
    Map<String, ByteIterator> buildUpdate() {
    ...
    public boolean doInsert(DB db, Object threadState) {
        int key = keysequence.nextInt();
        String dbkey = buildKeyName(key);
    ...
    public void doTransactionScan(DB db) {
        ...
        db.scan(table, startkeyname, len, fields, new Vector<Map<String, ByteIterator>>());
    }
