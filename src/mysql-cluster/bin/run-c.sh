...
workloads=("profile=mysql-cluster-${MYSQL_CLUSTER_VERSION}-c.workload target=0 operationcount=100000"

           "profile=mysql-cluster-${MYSQL_CLUSTER_VERSION}-c.workload target=100 operationcount=10000"
           ...
           "profile=mysql-cluster-${MYSQL_CLUSTER_VERSION}-c.workload target=2500 operationcount=200000"
           "profile=mysql-cluster-${MYSQL_CLUSTER_VERSION}-c.workload target=3000 operationcount=200000")
