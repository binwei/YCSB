...
workloads=("profile=couchbase-${COUCHBASE_VERSION}-f.workload target=0 operationcount=100000"

           "profile=couchbase-${COUCHBASE_VERSION}-f.workload target=100 operationcount=10000"
           ...
           "profile=couchbase-${COUCHBASE_VERSION}-f.workload target=1000 operationcount=100000"
           "profile=couchbase-${COUCHBASE_VERSION}-f.workload target=1500 operationcount=100000"
           "profile=couchbase-${COUCHBASE_VERSION}-f.workload target=2000 operationcount=100000")
