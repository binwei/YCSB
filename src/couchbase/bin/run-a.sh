...
workloads=("profile=couchbase-${COUCHBASE_VERSION}-a.workload target=0 operationcount=100000"

           "profile=couchbase-${COUCHBASE_VERSION}-a.workload target=100 operationcount=10000"
           ...
           "profile=couchbase-${COUCHBASE_VERSION}-a.workload target=2000 operationcount=100000"
           "profile=couchbase-${COUCHBASE_VERSION}-a.workload target=3000 operationcount=100000")
