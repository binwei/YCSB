...
workloads=("profile=mysql-sharded-${MYSQL_SHARDED_VERSION}-b.workload target=0 operationcount=100000"
           ...
           "profile=mysql-sharded-${MYSQL_SHARDED_VERSION}-b.workload target=800 operationcount=80000"
           ...
           "profile=mysql-sharded-${MYSQL_SHARDED_VERSION}-b.workload target=2000 operationcount=200000"
           "profile=mysql-sharded-${MYSQL_SHARDED_VERSION}-b.workload target=3000 operationcount=200000"
           "profile=mysql-sharded-${MYSQL_SHARDED_VERSION}-b.workload target=4000 operationcount=200000")
